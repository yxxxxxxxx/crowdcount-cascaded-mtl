...
class ImageDataLoader():
    def __init__(self, data_path_list, gt_path_list, shuffle=False, gt_downsample=False, pre_load=False, num_classes=10):
        ...
        if shuffle:
            random.seed(2468)
        self.num_samples = len(self.data_path_list)
        self.blob_list = {}        
    ...
    def preload_data(self):
        ...
        idx = 0
        for fname in self.data_path_list:            
    ...
    def read_image_and_gt(self,fname):
        ...
        den = pd.read_csv(os.path.join('/localSSD/yangxu/Lanzhou_Crowd/' + fname.split('/')[4] + '/' + fname.split('/')[5] + '/den/' + fname.split('/')[-1][:-4] + '.csv'), \
